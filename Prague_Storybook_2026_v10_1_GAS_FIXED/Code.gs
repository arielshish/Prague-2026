...
// Apps Script Backend - Code.gs  v10.0
...
var STOP_CATALOG = {
  ...
  'Primark Wenceslas Square': { mapUrl: 'https://www.google.com/maps/search/Primark+Wenceslas+Square+Prague', type: 'shopping' },
  'Palladium Prague': { mapUrl: 'https://www.google.com/maps/place/Palladium+shopping+centre,+Prague', type: 'shopping' },
  'Westfield Chodov': { mapUrl: 'https://www.google.com/maps/search/Westfield+Chodov+Prague', type: 'shopping' },
  'Fashion Arena Prague Outlet': { mapUrl: 'https://www.google.com/maps/search/Fashion+Arena+Prague+Outlet', type: 'shopping' },
...
function doGet() {
  return HtmlService.createHtmlOutputFromFile('index')
    .setTitle('פראג 2026 - משפחת שיש v10')
