> ⚠️ **ארכיון — לא בשימוש.** תמונת מצב ישנה של הפרויקט (גרסה @158, לפני המעבר ל-`gas_project/` + Firebase/app.html).
> המקור העדכני: `.claude/commands/prague-app.md`.

# Prague 2026 — Family Trip App Skill (ארכיון, מיושן)
