...
## פיצ'רים קיימים (עדכון 2026-07-18 — גרסה 8)
...
- **דיאלוג ניווט** (`showMapNavDialog(p, coords)`) — bottom sheet בלחיצה על כל pin:
  - 🗺️ Google Maps (mapUrl מהפריט)
  - 🚗 Waze (좌표 coordinates)
  - 📍 הצג במפה המקומית (zoom ל-17 על הנקודה)
  - סגור
  - מציג תג ✅ "כבר בלוז" אם המקום ב-DAYS
