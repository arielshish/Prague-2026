...
**⚠️ באג נתונים פתוח**: `Trdelník (טרדלניק)` ו-`מוזיאון החושים` באותה קואורדינטה `[50.0875, 14.4213]`; וכן `Westfield Chodov` ו-`Albert Supermarket — Chodov`. אחת מכל זוג שגויה — **לא נוחשה חלופה**, צריך אימות משני מקורות.
