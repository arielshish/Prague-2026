...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
    ...
    .bp-header { display: flex; justify-content: space-between; font-family: var(--font-en); font-size: 13px; font-weight: 700; color: var(--gold); letter-spacing: 2px; margin-bottom: 16px; }
    ...
    .bp-label { font-size: 12px; font-weight: 700; color: var(--gold); margin-bottom: 4px; }
  ...
  <div class="app-container">
    ...
    <main class="main-area">
      ...
      <div id="tab-info" class="tab">
        ...
        <!-- Recommendations -->
        <h2 style="font-size: 24px; margin: 0 0 16px;">מסעדות וקניות מומלצות 🥩🛍️</h2>
